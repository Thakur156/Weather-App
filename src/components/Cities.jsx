...
import { CityListContext } from "./CitiesListContext";
...
const Cities = () => {
  ...
  return isLoading ? (
    ...
    <div className="flex md:flex-row flex-col md:h-auto bg-black">
              ...
              <div className="flex flex-col h-full">
                <div className="basis-5/12 p-5 pt-12 relative">
                  <img
                    ...
                    src={Geturl(value[openIndex].data.list[0].weather[0].icon)}
                  />
